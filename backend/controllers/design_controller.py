...
def generate_design():
    try:
        ...
        mode = data.get("mode", "prompt").lower()
        prompt = data.get("prompt", "").strip()
        base_motif = data.get("base_motif", "").strip()
        ...
        # ==========================================
            ...
            if base_motif == "":
                return jsonify({
                    "success": False,
                    "message": "Silakan pilih motif batik."
                }), 400
...
def save_generated_design():
    try:
        ...
        save_activity(
            ...
            description=f"Membuat desain batik {data.get('motif_name', 'Custom')}"
        )
